...
//  using UnityEngine.Rendering.Universal;
    ...
    public class CustomSMAA1xRendererFeature : ScriptableRendererFeature
//  public class CustomSMAA1xRendererFeature : ScriptableRendererFeature
    {
//  {
        class CustomSMAA1xRenderPass : ScriptableRenderPass
//      class CustomSMAA1xRenderPass : ScriptableRenderPass
        {
//      {
            private Material m_Material;
//          private Material m_Material;
            private CustomSMAA1xComponent m_SMAAComponent;
//          private CustomSMAA1xComponent m_SMAAComponent;
...
//          private Texture2D m_SearchTex;
            ...
            private ProfilingSampler m_ProfilingSampler = new ProfilingSampler("Custom SMAA 1x");
//          private ProfilingSampler m_ProfilingSampler = new ProfilingSampler("Custom SMAA 1x");

            public CustomSMAA1xRenderPass(Material material, Texture2D areaTex, Texture2D searchTex)
//          public CustomSMAA1xRenderPass(Material material, Texture2D areaTex, Texture2D searchTex)
            {
//          {
                m_Material = material;
...
//              var stack = VolumeManager.instance.stack;
                m_SMAAComponent = stack.GetComponent<CustomSMAA1xComponent>();
//              m_SMAAComponent = stack.GetComponent<CustomSMAA1xComponent>();
...
//      public Settings settings = new Settings();
        private CustomSMAA1xRenderPass m_Pass;
//      private CustomSMAA1xRenderPass m_Pass;
        private Material m_Material;
//      private Material m_Material;
...
//          m_Material = CoreUtils.CreateEngineMaterial(settings.shader);
            m_Pass = new CustomSMAA1xRenderPass(m_Material, settings.areaTex, settings.searchTex);
//          m_Pass = new CustomSMAA1xRenderPass(m_Material, settings.areaTex, settings.searchTex);
        }
//      }
