...
//  using UnityEngine.Rendering.Universal;
    ...
    public class CustomSMAA4xRendererFeature : ScriptableRendererFeature
//  public class CustomSMAA4xRendererFeature : ScriptableRendererFeature
    {
//  {
        class CustomSMAA4xRenderPass : ScriptableRenderPass
//      class CustomSMAA4xRenderPass : ScriptableRenderPass
        {
//      {
            private Material m_Material;
//          private Material m_Material;
            private CustomSMAA4xComponent m_SMAAComponent;
//          private CustomSMAA4xComponent m_SMAAComponent;
...
//          private int m_FrameCount = 0;
            ...
            private ProfilingSampler m_ProfilingSampler = new ProfilingSampler("Custom SMAA 4x");
//          private ProfilingSampler m_ProfilingSampler = new ProfilingSampler("Custom SMAA 4x");

            public CustomSMAA4xRenderPass(Material material, Texture2D areaTex, Texture2D searchTex)
//          public CustomSMAA4xRenderPass(Material material, Texture2D areaTex, Texture2D searchTex)
            {
//          {
                m_Material = material;
...
//              var stack = VolumeManager.instance.stack;
                m_SMAAComponent = stack.GetComponent<CustomSMAA4xComponent>();
//              m_SMAAComponent = stack.GetComponent<CustomSMAA4xComponent>();
...
//      public Settings settings = new Settings();
        private CustomSMAA4xRenderPass m_Pass;
//      private CustomSMAA4xRenderPass m_Pass;
        private Material m_Material;
//      private Material m_Material;
...
//          m_Material = CoreUtils.CreateEngineMaterial(settings.shader);
            m_Pass = new CustomSMAA4xRenderPass(m_Material, settings.areaTex, settings.searchTex);
//          m_Pass = new CustomSMAA4xRenderPass(m_Material, settings.areaTex, settings.searchTex);
        }
//      }
